...
setGlobals 2
set -x
peer channel update -f org4_update_in_envelope.pb -c ${CHANNEL_NAME} -o orderer1.example.com:7050 --ordererTLSHostnameOverride orderer1.example.com --tls --cafile "$ORDERER1_CA"
{ set +x; } 2>/dev/null
