...
## Install chaincode on peer0.org1, peer0.org2, peer0.org3, peer0.org4
...
## expect org1 to have approved and org2, org3, org4 not to
...
## now approve also for org2, org3, org4
approveForMyOrg 2
approveForMyOrg 3
approveForMyOrg 4
