...
function createOrg8() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:16054 --caname ca-org8 --tls.certfiles "${PWD}/organizations/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:16054 --caname ca-org8 -M "${PWD}/organizations/peerOrganizations/org8.example.com/peers/peer0.org8.example.com/msp" --csr.hosts peer0.org8.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:16054 --caname ca-org8 -M "${PWD}/organizations/peerOrganizations/org8.example.com/peers/peer0.org8.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org8.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:16054 --caname ca-org8 -M "${PWD}/organizations/peerOrganizations/org8.example.com/users/User1@org8.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://org8admin:org8adminpw@localhost:16054 --caname ca-org8 -M "${PWD}/organizations/peerOrganizations/org8.example.com/users/Admin@org8.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrg9() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:17054 --caname ca-org9 --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Registering peer0"
  set -x
  fabric-ca-client register --caname ca-org9 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org9 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-org9 --id.name org9admin --id.secret org9adminpw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:17054 --caname ca-org9 -M "${PWD}/organizations/peerOrganizations/org9.example.com/peers/peer0.org9.example.com/msp" --csr.hosts peer0.org9.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:17054 --caname ca-org9 -M "${PWD}/organizations/peerOrganizations/org9.example.com/peers/peer0.org9.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org9.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  cp "${PWD}/organizations/peerOrganizations/org9.example.com/peers/peer0.org9.example.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/org9.example.com/msp/tlscacerts/ca.crt"

  mkdir -p "${PWD}/organizations/peerOrganizations/org9.example.com/tlsca"
  cp "${PWD}/organizations/peerOrganizations/org9.example.com/peers/peer0.org9.example.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/org9.example.com/tlsca/tlsca.org9.example.com-cert.pem"

  mkdir -p "${PWD}/organizations/peerOrganizations/org9.example.com/ca"
  cp "${PWD}/organizations/peerOrganizations/org9.example.com/peers/peer0.org9.example.com/msp/cacerts/"* "${PWD}/organizations/peerOrganizations/org9.example.com/ca/ca.org9.example.com-cert.pem"

  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:17054 --caname ca-org9 -M "${PWD}/organizations/peerOrganizations/org9.example.com/users/User1@org9.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://org9admin:org9adminpw@localhost:17054 --caname ca-org9 -M "${PWD}/organizations/peerOrganizations/org9.example.com/users/Admin@org9.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org9/tls-cert.pem"
  { set +x; } 2>/dev/null
